...
const char cmd_echo[] = "U";
const char cmd_IDN = 0x01;
...
int main(void)
{
	...
	Chip_UART_SendRB(LPC_USART, &txring, cmd_echo, sizeof(cmd_echo) - 1);
//	Chip_UART_SendRB(LPC_USART, &txring, inst2, sizeof(inst2) - 1);
	...
	Chip_UART_SendRB(LPC_USART, &txring, &cmd_IDN, sizeof(cmd_IDN) - 1);
