...
---- TEST DESCRIPTION ---------------------------------------------------
As to be found in main.c this Program counter test example will 
call every 500 ms the PC test (IEC60335_B_PCTest_BIST()). 

PASS:
The selected LED will blink a 1Hz rate
