...
/* this function is used to jump to the ram POST test, before the "normal" reset ISR */
extern void _RAMTest_POST_reset(void);
...
void (* const g_pfnVectors[])(void) = {
    ...
    _RAMTest_POST_reset,                    // The ram post test
