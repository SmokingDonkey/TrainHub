...
2.	The linker script file, PCtest_example.ld can be used to place the 
	PC test function throughout the memory. 
	

---- ADDITIONAL INFORMATION ---------------------------------------------
The Program counter test executes functions that are placed at specific 
locations of the FLASH and RAM memories.
These functions are placed at the right location by using the linker 
script file.
