...
/* this function is used to jump to the flash POST test, before the "normal" reset ISR */
extern void _FLASHTest_POST_reset(void);
...
void (* const g_pfnVectors[])(void) = {
    ...
    _FLASHTest_POST_reset,                  // Plug in the flash test post routine
