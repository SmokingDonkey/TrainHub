/**************************************************************************//**
 * $Id: system_LPC12xx.c 7758 2011-07-18 15:19:14Z gerritdewaard $
 *
...
#define SYSPLLCTRL_Val        0x00000060    //WORKING
//#define SYSPLLCTRL_Val        0x00000024
#define MAINCLKSEL_Val        0x00000001
#define WDTOSC_SETUP          0
#define WDTOSCCTRL_Val        0x00000001
#define SYSAHBCLKDIV_Val      0x00000001  //WORKING
//#define SYSAHBCLKDIV_Val      0x00000003
...
void SystemInit (void)
{
  ...
  LPC_SYSCON->SYSAHBCLKCTRL = (uint32_t) 0x00000001F;
#endif 
  ...
  LPC_SYSCON->SYSAHBCLKCTRL |= (1u<<31);  
}
