...
#define SBL_MST_SLAVE_RDY_DELAY				(1)
#define SBL_MST_ERASE_FLASH_DELAY           (100)
#define SBL_MST_PROG_FLASH_DELAY            (100)
#define SBL_MST_PROG_FLASH_TIMEOUT          (2000)
#elif (SBL_CONNECTION == SBL_SPI)
