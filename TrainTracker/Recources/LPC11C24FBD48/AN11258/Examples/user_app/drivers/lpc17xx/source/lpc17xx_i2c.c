...
void I2C_Init(void)
{
    ...
    /* Set clock rate */
    LPC_SC->PCLKSEL0 &= ~(0x03 << 14);
    LPC_SC->PCLKSEL0 |= div << 14;

    temp = (SystemCoreClock/div) / I2C_CLK_RATE_USED;
...
void I2C_Cmd(FunctionalState NewState)
{
    if (NewState == ENABLE)
    {
        I2C_DEV->I2CONSET = I2C_I2CONSET_I2EN | I2C_I2CONSET_AA;
    }
    else
    {
        I2C_DEV->I2CONCLR = 0xFF;
...
int32_t I2C_SlaveHanleStates(uint32_t CodeStatus, I2C_S_SETUP_Type *TransferCfg)
{
    ...
    switch (CodeStatus)
    {
        ...
        case I2C_I2STAT_S_RX_ARB_LOST_M_GENCALL:
            I2C_DEV->I2CONCLR = I2C_I2CONCLR_SIC;
            I2C_DEV->I2CONSET = I2C_I2CONSET_AA|I2C_I2CONSET_STA;
            break;
...
Status I2C_SlaveTransferData(I2C_S_SETUP_Type *TransferCfg)
{
    ...
    {    
        while (1)
        {
            ...
            {
                if(!(I2C_DEV->I2CONSET & I2C_I2CONSET_AA))
                {
                   I2C_DEV->I2CONSET = I2C_I2CONSET_AA;
                }
            }
...
s_end_stage:
        ...
        I2C_DEV->I2CONCLR = I2C_I2CONCLR_AAC;
...
void I2C_SetOwnSlaveAddr(void)
{
    ...
    I2C_DEV->I2ADR0 = tmp;
    I2C_DEV->I2MASK0 = I2C_I2MASK_MASK(0xFF);
}
/**
 * @}
 */
