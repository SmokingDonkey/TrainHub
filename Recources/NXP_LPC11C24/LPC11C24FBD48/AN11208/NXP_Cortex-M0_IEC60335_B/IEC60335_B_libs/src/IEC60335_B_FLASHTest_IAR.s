;/****************************************************************************
; *   $Id:: IEC60335_B_FLASHTest_IAR.s 7461 2011-06-01 13:01:58Z gerritdewaa#$
...
;****************************************************************************/
  ...
  SECTION .text:CODE
  PUBLIC  _FLASHTestPOST	
  PUBLIC  _FLASHTestBIST
...
;------------------------------------------------------------------------------
  ...
  PUBWEAK _flashPostTestFailureHook
  PUBWEAK _flashBistTestFailureHook
...
_loop_label
  ...
  cmp   r6, r7
  bneq  _loop_label                   ; wait for flag done   
...
_misr_hw_sigcheck
  ...
  bneq  _misr_hw_failed         ; if different, test failed
  subs  r4, #1
  cmp   r4, r8                  
