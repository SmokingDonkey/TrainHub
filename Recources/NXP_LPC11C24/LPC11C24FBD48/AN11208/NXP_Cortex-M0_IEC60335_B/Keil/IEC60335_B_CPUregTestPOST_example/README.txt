...
---- DIRECTORY STRUCTURE ------------------------------------------------
 Target						-> 	Select your target, LPC1114 or LPC1227
	...
	|							
	+ Application   		->	This directory contains the main sources 
	|							for this example
...
The IEC60335 Class B CPU register test POST will be called prior to the 
branch to main. The call to the test can be found in the 
startup_LPCxxxx_CPUTestPOST.s assembly file.
...
cpuPostFailure_userHookFunction_ARM.s.
