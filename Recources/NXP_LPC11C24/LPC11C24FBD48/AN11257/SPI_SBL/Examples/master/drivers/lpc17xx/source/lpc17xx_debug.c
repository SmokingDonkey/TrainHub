/**********************************************************************
* $Id$		lpc17xx_debug.c				2012-05-09
*//**
* @file		lpc17xx_debug.c
...
void DebugInit(void)
{
     ...
     */
    LPC_PINCON->PINSEL0 = (LPC_PINCON->PINSEL0 & (~0xF0))|0x50;   // Clear bit 4:7
    LPC_PINCON->PINMODE0 &= ~0xF0;   //Clear bit 4:7 
    LPC_PINCON->PINMODE_OD0 &= ~0x0C;      //Clear bit 2:3
