...
static uint32_t *PIN_GetPointer(uint8_t portnum, uint8_t pinnum)
{
    ...
    if(portnum == 0){
        ...
        case 9:
            ...
            break;
        case 10:
            pPIN = (uint32_t *)&LPC_IOCON->PIO0_10;
            break;
        case 11:
            pPIN = (uint32_t *)&LPC_IOCON->PIO0_11;
            break;
        }
        ...
        switch(pinnum){
        case 0:
            pPIN = (uint32_t *)&LPC_IOCON->PIO1_0;
            break;
        case 1:
            pPIN = (uint32_t *)&LPC_IOCON->PIO1_1;
            break;
        case 2:
            pPIN = (uint32_t *)&LPC_IOCON->PIO1_2;
            break;
        case 3:
            pPIN = (uint32_t *)&LPC_IOCON->ARM_SWDIO_PIO1_3;
            break;
        case 4:
