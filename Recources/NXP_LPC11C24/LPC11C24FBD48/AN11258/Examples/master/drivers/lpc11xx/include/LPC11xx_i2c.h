...
#ifndef LPC11xx_I2C_H
#define LPC11xx_I2C_H
 ...
 * @{
 */
#define I2C_DEV                          (LPC_I2C)
#define I2C_CLK_RATE_USED                (1000000) //1MHz
...
//#define I2C_STAT_S_RX_SLAW_ACK                ((0x68))
...
/** General call address has been received, ACK has been returned */
//#define I2C_STAT_S_RX_GENCALL_ACK             ((0x78))
...
/** Own SLA+R has been received, ACK has been returned */
//#define I2C_STAT_S_TX_SLAR_ACK                ((0xB0))

/** Data has been transmitted, ACK has been received */
#define I2C_STAT_S_TX_DAT_ACK                   ((0xB8))
/** Data has been transmitted, NACK has been received */
#define I2C_STAT_S_TX_DAT_NACK                  ((0xC0))
/** Last data byte in DAT has been transmitted (AA = 0);
 ...
 *********************************************************************/
/** Mask for DAT register*/
#define I2C_DAT_BITMASK              ((0xFF))
...
#define DATA_BUFFER_BITMASK          ((0xFF))
